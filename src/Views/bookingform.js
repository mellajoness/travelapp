...
export default class BookingFormScreen extends Component {
  ...
  render() {
    return (
        <View style={{flex:1}}>
        <View style={{paddingHorizontal:20, backgroundColor: 'white', borderTopLeftRadius: 20, borderTopRightRadius:20,borderBottomColor:'#f8f8f8',borderBottomWidth:1,position:'relative',bottom:20}}>
          
         

        <Text style={{color:'gray',paddingTop:30,fontWeight:'bold'}}>From</Text>
    ...
    <Text style={{color:'gray',paddingTop:15,fontWeight:'bold'}}>Date</Text>
     <DatePicker
        style={{width: '100%',height:50,backgroundColor:'#DAD9D9',borderBottomWidth:10,borderBottomColor:'#DAD9D9',}}
        date={this.state.date}
        mode="date"
      ...
      /> 
          <TouchableOpacity  onPress={this.booking}
             style={{backgroundColor:'#2492D6',height:50,borderRadius:4,justifyContent:'center',marginTop:30,width:'100%'}} >
